...
class Graph:
    ...
    def neighbours(self, node: Hashable) -> ReadOnly:
        ...
        return ReadOnly(self.adjacencyDic[node][1])
    
    @property
    def nodes(self):
        return list(self.adjacencyDic.keys())
...
class UndirectedGraph(Graph):
    ...
    def add_edge(self, node_1: Hashable, node_2: Hashable, weight: float = 1) -> None:
        super().insertEdge(node_1, node_2, weight)
        super().insertEdge(node_2, node_1, weight)

    def delete_edge(self, node_1: Hashable, node_2: Hashable) -> None:
        super().deleteEdge(node_1, node_2)
        super().deleteEdge(node_2, node_1)